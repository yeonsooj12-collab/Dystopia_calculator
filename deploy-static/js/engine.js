...
(function attachEngine(root) {
  ...
  function evaluateAmplifierFit(coreSelection = {}, amplifierSelection = {}) {
    ...
    const warnings = [];
    if (selectedCount > 2) warnings.push("풍자 증폭 요소가 너무 많습니다.");
    return {
      rawScore,
  ...
  if (root) root.SatireIdeaEngine = api;
